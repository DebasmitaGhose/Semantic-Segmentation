...
def train(batch_size, epochs, lr_base, lr_power, weight_decay, classes,
    ...
    def get_pascal_labels():
        ...
        Returns:
            np.ndarray with dimensions (21, 3)cc
        """
    ...
    def encode_segmap(mask):
        ...
        #print mask.shape
        label_mask = np.zeros((mask.shape[0],mask.shape[1], mask.shape[2]), dtype=np.int16)
    ...
    #X = load_train_images_from_folder('/media/epsilon90/Shasvat/MS Sem2/CMPSCI 690IV/segmentation/dataset/VOCdevkit/VOC2012/new/trial/')
    #y = load_train_images_from_folder('/media/epsilon90/Shasvat/MS Sem2/CMPSCI 690IV/segmentation/dataset/VOCdevkit/VOC2012/trial_test/')
    
    X = load_train_images_from_folder('C://Users//User//Documents//UMass Amherst//Semester 2//COMPSCI 690IV - Intelligent Visual Computing//Project - Semantic Segmentation//VOCtrainval_11-May-2012//VOCdevkit//VOC2012//trial/')
    y = load_train_images_from_folder('C://Users//User//Documents//UMass Amherst//Semester 2//COMPSCI 690IV - Intelligent Visual Computing//Project - Semantic Segmentation//VOCtrainval_11-May-2012//VOCdevkit//VOC2012//trial_test/')
   ...
   # print((X[0]).shape)
    ...
    model.fit(X, y_en, epochs=2, batch_size=1,callbacks=callbacks)
...
if __name__ == '__main__':
    ...
    if dataset == 'VOC2012_BERKELEY':
        ...
        #data_dir='/media/epsilon90/Shasvat/MS Sem2/CMPSCI 690IV/segmentation/dataset/VOCdevkit/VOC2012/new/JPEGImages/'
        ...
        train_file_path = os.path.abspath('C://Users//User//Documents//UMass Amherst//Semester 2//COMPSCI 690IV - Intelligent Visual Computing//Project - Semantic Segmentation//VOCtrainval_11-May-2012//VOCdevkit//VOC2012//ImageSets//Segmentation//train.txt') #Data/VOClarge/VOC2012/ImageSets/Segmentation
        # train_file_path = os.path.expanduser('~/.keras/datasets/oneimage/train.txt') #Data/VOClarge/VOC2012/ImageSets/Segmentation
        val_file_path   = os.path.abspath('C://Users//User//Documents//UMass Amherst//Semester 2//COMPSCI 690IV - Intelligent Visual Computing//Project - Semantic Segmentation//VOCtrainval_11-May-2012//VOCdevkit//VOC2012//ImageSets//Segmentation//train_val.txt')#
        data_dir        = os.path.abspath('C://Users//User//Documents//UMass Amherst//Semester 2//COMPSCI 690IV - Intelligent Visual Computing//Project - Semantic Segmentation//VOCtrainval_11-May-2012//VOCdevkit//VOC2012//trial')#
        label_dir       = os.path.abspath('C://Users//User//Documents//UMass Amherst//Semester 2//COMPSCI 690IV - Intelligent Visual Computing//Project - Semantic Segmentation//VOCtrainval_11-May-2012//VOCdevkit//VOC2012//trial_test')#
        data_suffix='.jpg'
        label_suffix='.png'
        classes = 21
    if dataset == 'COCO':
