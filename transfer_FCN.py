...
def transfer_FCN_Vgg16():
    ...
    weights_path = os.path.expanduser(os.path.join('~', 'C:/Users/User/Documents/UMass Amherst/Semester 2/COMPSCI 690IV - Intelligent Visual Computing/Project - Semantic Segmentation/Keras-FCN/Models/FCN_Vgg16_32s/vgg16.h5'))
...
def transfer_FCN_ResNet50():
    ...
    # Create model
    model = Model(img_input, x)
    weights_path = os.path.expanduser(os.path.join('~', 'C:/Users/User/Documents/UMass Amherst/Semester 2/COMPSCI 690IV - Intelligent Visual Computing/Project - Semantic Segmentation/Keras-FCN/Models/FCN_Resnet50_32s/resnet32.h5'))
